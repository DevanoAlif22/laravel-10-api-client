        ...
        <div class="form-login">
            ...
            <form action="" method="post">
                ...
                <div class="mb-5">
                    ...
                    <input name="name" type="text" class="form-control" id="exampleFormControlInput2" placeholder="steve jobs">
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input name="confirmPassword" type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock">
                </div>
